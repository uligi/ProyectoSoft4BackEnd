...
[ApiController]
public class ApiComentariosTareas : ControllerBase
{
    private readonly IComentariosTareasRepository _service;

    public ApiComentariosTareas(IComentariosTareasRepository service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> AgregarComentario([FromBody] ComentariosTareasRequest comentario)
    {
        try
        {
    ...
    public async Task<IActionResult> ActualizarComentario(int id, [FromBody] ComentariosTareasRequest comentario)
    {
        try
        {
